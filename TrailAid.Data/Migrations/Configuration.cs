namespace TrailAid.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TrailAid.Data.ApplicationUser.ApplicationDbContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "TrailAid.Data.ApplicationUser+ApplicationDbContext";
        }
        

            protected override void Seed(TrailAid.Data.ApplicationUser.ApplicationDbContext context)
        {
            ...
            //List Of All tags
            context.AllTags.Add(new AllTags());
